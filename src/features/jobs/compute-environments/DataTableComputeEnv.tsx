...
interface DataTableComputeEnvProps<TData, TValue> {
...
export function DataTableComputeEnv<TData, TValue>({
    columns,
    data,
    linkAwsConsole,
    awsRegion,
    ...
    currentStack,
    isQueryLoading
}: DataTableComputeEnvProps<TData, TValue>) {
    ...
    const { refreshQuery, isRefreshing } = useRefreshQuery(jobQueries.computeEnvQueryKey(awsRegion!, awsProfile!, currentStack!));
        ...
        <>
            <div className="pb-4 flex items-center justify-between">
                <DataTableHeader
                    ...
                    description={`Set of compute resources, in Brender Studio it's used to define the EC2 instances that will be used to render the jobs.`}
                />
