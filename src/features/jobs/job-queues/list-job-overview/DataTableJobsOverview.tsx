...
interface DataTableJobsOverviewProps<TData, TValue> {
...
export function DataTableJobsOverview<TData, TValue>({
    columns,
    data,
    linkAwsConsole,
    awsRegion,
    ...
    currentStack,
    isQueryLoading
}: DataTableJobsOverviewProps<TData, TValue>) {
    ...
    const { refreshQuery, isRefreshing } = useRefreshQuery(jobQueries.jobExecutionsQueryKey(awsRegion, awsProfile, currentStack))
        ...
        <>
            <div className="pb-4 flex items-center justify-between">
                <DataTableHeader
                    ...
                    description={`Status of the job queues for rendering jobs. Click on cells to view more details.`}
                />
